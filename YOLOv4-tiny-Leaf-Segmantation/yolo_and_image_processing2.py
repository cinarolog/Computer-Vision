...
for max_id in max_ids:
    ...
    cv2.rectangle(result, (start_x,start_y),(end_x,end_y),box_color,1)
    cv2.putText(result,label,(start_x,start_y-10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, box_color, 1)


#cv2.imshow("Detection Window", image)
cv2.imshow("Detection Window", result)
