# -*- coding: utf-8 -*-
"""
Created on Tue Jan 18 01:47:47 2022
...
while True:
    ...
    cv2.imshow('Dortgen ve Cizgi Eklenmis Resim', frame)


    model = cv2.dnn.readNetFromDarknet("gate-yolov3-tiny.cfg","gate-yolov3-tiny-obj_last.weights")
